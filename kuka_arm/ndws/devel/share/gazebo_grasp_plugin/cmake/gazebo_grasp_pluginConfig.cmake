...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/robond/Documents/ND_projects/kuka_arm/ndws/src/RoboND-Kinematics-Project/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/robond/Documents/ND_projects/kuka_arm/ndws/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/robond/Documents/ND_projects/kuka_arm/ndws/install)
...
if(NOT "/home/robond/Documents/ND_projects/kuka_arm/ndws/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/robond/Documents/ND_projects/kuka_arm/ndws/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Documents/ND_projects/kuka_arm/ndws/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/${idir}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
    endif()
...
set(depends "gazebo_ros;geometry_msgs;roscpp;std_msgs")
